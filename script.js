...
const translations = {
  en: {
    ...
    "project.ifeap.title": "UX/UI redesign, WordPress development, Dendreo integration",
    "project.ifeap.desc": "For IFEAP, an organization dedicated to training, support, and consulting, I handled the complete website redesign: clearer UX, a more modern interface, WordPress development, and Dendreo integration for training management.",
    "project.ifeap.role": "UX/UI / WordPress / Dendreo",
    "project.ifeap.category": "Training organization website",
    "project.ifeap.m1": "UX/UI design",
    "project.ifeap.m2": "Global redesign",
    ...
    "project.templiers.desc": "Creation of a showcase website for L&rsquo;Atelier des Templiers, with a direction focused on craft, clarity, and credibility. The work covered visual design, content structure, and responsive integration.",
    "project.templiers.role": "Interface design / Web integration",
    "project.templiers.category": "Artisan showcase website",
    "project.templiers.m1": "Interface design",
    ...
    "project.noria.title": "WooCommerce ecommerce redesign",
    "project.noria.desc": "For Noria du Soleil, I worked on the redesign and integration of a WooCommerce ecommerce website. The goal was to create an elegant, immersive, and functional online store for perfume collections, key products, and the brand universe.",
    "project.noria.role": "WooCommerce / Ecommerce design",
    "project.noria.category": "Perfume ecommerce",
    "project.noria.m1": "Web redesign",
    ...
    "project.noria.m5": "Ecommerce design",
    "project.talaria.title": "Landing page and mobile app design",
    "project.talaria.desc": "Talaria is an app designed to simplify group travel organization: planning, shared budget, activity choices, and comparison of flights, stays, and experiences. I worked on the landing page and mobile app interface with a modern, product-oriented visual direction.",
    "project.talaria.role": "UX/UI / Landing page / Mobile app",
    "project.talaria.category": "Collaborative travel product",
    "project.talaria.m1": "UX/UI design",
    "project.talaria.m2": "Landing page",
    "project.talaria.m3": "Mobile app design",
    "project.talaria.m4": "Clear UX for a collaborative digital product",
    "about.eyebrow": "About",
    "about.p1": "I&rsquo;m Marceau Hay, a French UX/UI creator and web creator currently completing a master&rsquo;s degree in UX/UI after earning a bachelor&rsquo;s degree in web design. I work at the intersection of interface design, digital clarity, and execution. What I enjoy most is shaping ideas into experiences that are both aesthetically strong and strategically useful.",
    "about.p2": "My background combines freelance work, design studies, web development, and entrepreneurial projects. This hybrid approach helps me think beyond visuals alone, from structure and messaging to user experience and final implementation.",
    "services.eyebrow": "What I do",
    "services.title": "Clear digital work from structure to design, development, and launch.",
    ...
    "services.product": "Offer design, positioning, conversion logic, digital business ideas.",
    ...
    "mega.design.title": "UX/UI & Web Design",
    "mega.design.text": "Wireframes, interfaces, landing pages, visual systems, and refined layouts.",
    "mega.designbuild.title": "Design + Development",
    "mega.designbuild.text": "From design direction to responsive implementation and launch-ready pages.",
    ...
    "background.title": "A compact path across design, web, and independent creation.",
    "background.item1": "Master&rsquo;s degree in UX/UI design",
    "background.item2": "Bachelor&rsquo;s degree in web design",
    ...
    "skills.title": "A focused skill set across product design, web, and implementation.",
    "blog.eyebrow": "Blog",
    "blog.title": "Notes on design, web development, and digital products.",
    "blog.read": "Read note",
    "faq.eyebrow": "FAQ",
    "faq.title": "A few direct answers before we talk.",
    "faq.q1": "What kind of projects do you work on?",
    "faq.a1": "I work on UX/UI design, landing pages, showcase websites, digital products, and product-oriented web experiences.",
    "faq.q2": "Can you design and build the same project?",
    "faq.a2": "Yes. Depending on the scope, I can work from structure and interface design through to WordPress, Elementor, or custom HTML/CSS implementation.",
    ...
    "contact.text": "Whether you need a designer, a freelance collaborator, or someone who can shape and execute a digital experience from idea to interface, I&rsquo;d be happy to connect.",
    ...
    "service.audit.lead": "A focused diagnosis of your website or interface, designed to identify friction, sharpen messaging, and define practical improvements before investing in redesign or development.",
    ...
    "service.audit.item4": "Next-step roadmap for design or implementation",
    ...
    "service.design.kicker": "Service / Design",
    "service.design.title": "UX/UI and web design with structure, restraint, and precision.",
    "service.design.lead": "I design interfaces and websites that feel clear, intentional, and usable. The work covers structure, visual direction, interaction patterns, responsive layouts, and the details that make a digital experience credible.",
    "service.design.primary": "Start a design project",
    "service.design.best": "Landing pages, portfolios, SaaS screens",
    "service.design.output": "High-fidelity responsive design",
    "service.design.focus": "UX, hierarchy, visual systems",
    "service.design.section1.eyebrow": "Design scope",
    ...
    "service.design.card2.title": "Visual design",
    ...
    "service.design.card3.text": "Desktop, tablet, and mobile screens designed with real constraints and usage in mind.",
    "service.design.card4.title": "Design system basics",
    ...
    "service.design.item2": "High-fidelity interface designs",
    ...
    "service.build.kicker": "Service / Design + Development",
    "service.build.title": "From polished design direction to a responsive live website.",
    "service.build.lead": "A combined offer for projects that need both taste and execution. I shape the structure, design the interface, then build production-ready pages with clean responsive implementation.",
    ...
    "service.build.output.value": "Designed and implemented pages",
    ...
    "service.build.output": "Designed and implemented pages",
    ...
    "service.build.card1.text": "Define the offer, page purpose, audience, hierarchy, and conversion logic before designing screens.",
    "service.build.card2.title": "Design system",
    ...
    "service.build.section2.title": "Design quality with implementation clarity.",
    "service.build.item1": "Page strategy and content structure",
    "service.build.item2": "Responsive interface design",
    "service.build.item3": "HTML/CSS or WordPress implementation",
    "service.build.item4": "Launch-ready QA and final refinements",
    "service.build.cta.title": "Need someone who can design and ship the page?",
    ...
    "service.product.lead": "For early-stage ideas, service offers, and digital products that need clearer positioning before design. I help organize the message, the value, and the conversion logic behind the interface.",
    ...
    "service.product.item4": "Recommendations for design and execution",
  ...
  fr: {
    ...
    "project.templiers.role": "Design d&rsquo;interface / Intégration web",
    "project.templiers.category": "Site vitrine artisan",
    "project.templiers.m1": "Design d&rsquo;interface",
    ...
    "project.noria.role": "WooCommerce / Design e-commerce",
    ...
    "project.noria.m5": "Design e-commerce",
    "project.talaria.title": "Landing page et design d&rsquo;application mobile",
    ...
    "project.talaria.m1": "UX/UI design",
    "project.talaria.m2": "Landing page",
    "project.talaria.m3": "Design mobile app",
    "project.talaria.m4": "Expérience utilisateur claire pour un produit digital collaboratif",
    "about.eyebrow": "À propos",
    "about.p1": "Je suis Marceau Hay, concepteur UX/UI et concepteur web français. Je poursuis actuellement un master en UX/UI après une licence en web design. J&rsquo;aime travailler les interfaces comme des objets clairs : bien structurés, lisibles, utiles et visuellement justes.",
    "about.p2": "Mon parcours mêle freelance, études de design, développement web et projets personnels. Cette combinaison me permet de regarder un projet au-delà de son apparence : structure, message, expérience utilisateur, faisabilité et exécution finale.",
    ...
    "mega.designbuild.title": "Design + Développement",
    "mega.designbuild.text": "De la direction design à l&rsquo;implémentation responsive, jusqu&rsquo;aux pages prêtes à publier.",
    ...
    "background.title": "Un parcours construit entre design, web et expérimentation indépendante.",
    "background.item1": "Master en design UX/UI",
    "background.item2": "Licence en web design",
    ...
    "skills.title": "Un socle complet entre design produit, web et intégration.",
    "blog.eyebrow": "Blog",
    "blog.title": "Notes sur le design, le développement web et les produits digitaux.",
    ...
    "faq.q2": "Peux-tu designer et construire un même projet ?",
    "faq.a2": "Oui. Selon le scope, je peux intervenir du cadrage et du design d&rsquo;interface jusqu&rsquo;à l&rsquo;implémentation WordPress, Elementor ou HTML/CSS custom.",
    ...
    "contact.text": "Si vous cherchez un designer, un collaborateur freelance ou quelqu&rsquo;un capable de passer d&rsquo;une idée à une interface bien exécutée, je serais ravi d&rsquo;échanger.",
    ...
    "service.audit.item4": "Feuille de route pour design ou implémentation",
    ...
    "service.design.kicker": "Service / Design",
    "service.design.title": "Design UX/UI et web design avec structure, retenue et précision.",
    ...
    "service.design.primary": "Lancer un projet design",
    "service.design.best": "Landing pages, portfolios, interfaces SaaS",
    "service.design.output": "Design responsive haute fidélité",
    "service.design.focus": "UX, hiérarchie, systèmes visuels",
    "service.design.section1.eyebrow": "Périmètre design",
    ...
    "service.design.card2.title": "Design visuel",
    ...
    "service.design.card4.title": "Bases de design system",
    ...
    "service.design.item2": "Designs d&rsquo;interface haute fidélité",
    ...
    "service.build.kicker": "Service / Design + Développement",
    "service.build.title": "De la direction design à un site responsive en ligne.",
    "service.build.lead": "Une offre combinée pour les projets qui ont besoin de goût et d&rsquo;exécution. Je structure, je designe, puis je développe des pages propres et prêtes à publier.",
    ...
    "service.build.output.value": "Pages designées et implémentées",
    "service.build.focus.label": "Stack",
    "service.build.focus.value": "HTML/CSS, WordPress, Elementor",
    "service.build.best": "Sites web, landing pages, lancements",
    "service.build.output": "Pages designées et implémentées",
    "service.build.focus": "HTML/CSS, WordPress, Elementor",
    ...
    "service.build.card1.text": "Objectif, audience, hiérarchie et logique de conversion avant de designer.",
    ...
    "service.build.section2.title": "Qualité design et clarté d&rsquo;implémentation.",
    "service.build.item1": "Stratégie de page et structure de contenu",
    "service.build.item2": "Design responsive",
    "service.build.item3": "Implémentation HTML/CSS ou WordPress",
    "service.build.item4": "QA et finitions pré-lancement",
    "service.build.cta.title": "Besoin de designer et publier une page ?",
    ...
    "service.product.lead": "Pour les idées, offres de service et produits digitaux qui ont besoin d&rsquo;un positionnement plus clair avant le design.",
    ...
    "service.product.item4": "Recommandations design et exécution",
  ...
  es: {
    "meta.title": "Marceau Hay - Dise&ntilde;ador UX/UI y Web",
    "nav.work": "Trabajo",
    ...
    "project.ifeap.title": "Redise&ntilde;o UX/UI, desarrollo WordPress, integracion Dendreo",
    "project.ifeap.desc": "Para IFEAP, una organizacion dedicada a formacion, acompa&ntilde;amiento y consultoria, me encargue del redise&ntilde;o completo del sitio: UX mas clara, interfaz modernizada, desarrollo WordPress e integracion de Dendreo para gestionar formaciones.",
    "project.ifeap.role": "UX/UI / WordPress / Dendreo",
    "project.ifeap.category": "Sitio de organismo de formacion",
    "project.ifeap.m1": "Dise&ntilde;o UX/UI",
    "project.ifeap.m2": "Redise&ntilde;o global",
    ...
    "project.templiers.role": "Dise&ntilde;o de interfaz / Integracion web",
    "project.templiers.category": "Sitio vitrina artesanal",
    "project.templiers.m1": "Dise&ntilde;o de interfaz",
    ...
    "project.noria.title": "Redise&ntilde;o ecommerce WooCommerce",
    "project.noria.desc": "Para Noria du Soleil, trabaje en el redise&ntilde;o e integracion de un ecommerce WooCommerce. El objetivo era crear una tienda online elegante, inmersiva y funcional para presentar colecciones de perfumes, productos clave y el universo de marca.",
    "project.noria.role": "WooCommerce / Dise&ntilde;o ecommerce",
    "project.noria.category": "Ecommerce de perfumes",
    "project.noria.m1": "Redise&ntilde;o web",
    ...
    "project.noria.m5": "Dise&ntilde;o ecommerce",
    "project.talaria.title": "Landing page y dise&ntilde;o de aplicacion movil",
    ...
    "project.talaria.m1": "Dise&ntilde;o UX/UI",
    "project.talaria.m2": "Landing page",
    "project.talaria.m3": "Dise&ntilde;o mobile app",
    "project.talaria.m4": "UX clara para un producto digital colaborativo",
    "about.eyebrow": "Perfil",
    "about.p1": "Soy Marceau Hay, dise&ntilde;ador UX/UI y dise&ntilde;ador web franc&eacute;s. Actualmente curso un master en UX/UI despues de una licenciatura en dise&ntilde;o web. Me interesa crear interfaces claras: bien estructuradas, legibles, utiles y visualmente precisas.",
    "about.p2": "Mi recorrido combina proyectos freelance, estudios de dise&ntilde;o, desarrollo web e iniciativas propias. Esa mezcla me ayuda a mirar cada proyecto mas alla de lo visual: estructura, mensaje, experiencia de usuario, viabilidad y ejecucion final.",
    "services.eyebrow": "Lo que hago",
    "services.title": "Del planteamiento inicial a la interfaz, del desarrollo al lanzamiento.",
    "services.ux.title": "Dise&ntilde;o UX/UI",
    "services.ux": "Flujos de usuario, arquitectura, wireframes, sistemas de interfaz y experiencia global.",
    "services.web.title": "Dise&ntilde;o Web",
    ...
    "background.title": "Un recorrido entre dise&ntilde;o, web y experimentacion independiente.",
    "background.item1": "Master en dise&ntilde;o UX/UI",
    "background.item2": "Licenciatura en dise&ntilde;o web",
    ...
    "skills.title": "Una base completa entre diseño de producto, web e implementación.",
    "blog.eyebrow": "Blog",
    "blog.title": "Notas sobre dise&ntilde;o, desarrollo web y productos digitales.",
    "blog.read": "Leer nota",
    "faq.eyebrow": "FAQ",
    "faq.title": "Algunas respuestas claras antes de hablar.",
    "faq.q1": "En que tipo de proyectos trabajas?",
    "faq.a1": "Trabajo en dise&ntilde;o UX/UI, landing pages, sitios de presentacion, productos digitales y experiencias web con criterio de producto.",
    "faq.q2": "Puedes dise&ntilde;ar y construir el mismo proyecto?",
    "faq.a2": "Si. Segun el alcance, puedo trabajar desde la estructura y el dise&ntilde;o de interfaz hasta WordPress, Elementor o implementacion HTML/CSS a medida.",
    ...
    "contact.text": "Si buscas un dise&ntilde;ador, un colaborador freelance o alguien capaz de llevar una idea hasta una interfaz bien ejecutada, me encantara conversar.",
    ...
    "service.audit.lead": "Un diagnostico enfocado de tu sitio o interfaz para detectar fricciones, afinar el mensaje y definir mejoras concretas antes de redise&ntilde;ar o desarrollar.",
    ...
    "service.audit.item4": "Roadmap para dise&ntilde;o o implementacion",
    ...
    "service.design.kicker": "Servicio / Dise&ntilde;o",
    "service.design.title": "Dise&ntilde;o UX/UI y web con estructura, contencion y precision.",
    "service.design.lead": "Dise&ntilde;o interfaces y sitios web claros, intencionales y faciles de usar. El trabajo cubre estructura, direccion visual, interacciones, responsive y detalles de credibilidad.",
    "service.design.primary": "Iniciar proyecto de dise&ntilde;o",
    "service.design.best": "Landing pages, portfolios, pantallas SaaS",
    "service.design.output": "Dise&ntilde;o responsive de alta fidelidad",
    "service.design.focus": "UX, jerarquia, sistemas visuales",
    "service.design.section1.eyebrow": "Alcance de dise&ntilde;o",
    ...
    "service.design.card2.title": "Dise&ntilde;o visual",
    "service.design.card2.text": "Tipografia, espaciado, layout, contraste, componentes y direccion adecuada al proyecto.",
    "service.design.card3.title": "Responsive",
    "service.design.card3.text": "Pantallas desktop, tablet y movil dise&ntilde;adas con restricciones reales.",
    "service.design.card4.title": "Bases de design system",
    ...
    "service.design.item2": "Dise&ntilde;os de interfaz de alta fidelidad",
    ...
    "service.build.lead": "Una oferta combinada para proyectos que necesitan gusto y ejecucion. Estructuro, dise&ntilde;o y desarrollo paginas listas para publicar.",
    ...
    "service.build.output.value": "Paginas dise&ntilde;adas e implementadas",
    "service.build.focus.label": "Stack",
    "service.build.focus.value": "HTML/CSS, WordPress, Elementor",
    "service.build.best": "Sitios web, landing pages, lanzamientos",
    "service.build.output": "Paginas dise&ntilde;adas e implementadas",
    "service.build.focus": "HTML/CSS, WordPress, Elementor",
    ...
    "service.build.card1.text": "Objetivo, audiencia, jerarquia y logica de conversion antes de dise&ntilde;ar.",
    ...
    "service.build.section2.title": "Calidad de dise&ntilde;o con claridad de implementacion.",
    ...
    "service.build.cta.title": "Necesitas dise&ntilde;ar y publicar una pagina?",
    ...
    "service.product.lead": "Para ideas, ofertas de servicio y productos digitales que necesitan un posicionamiento mas claro antes del dise&ntilde;o.",
    ...
    "service.product.item4": "Recomendaciones de dise&ntilde;o y ejecucion",
...
const setupMobileMenu = () => {
  ...
  panel.innerHTML = `
    ...
    <div class="mobile-menu-services">
      ...
      <a class="mobile-service-link" href="service-design.html"><strong data-i18n="mega.design.title">UX/UI & Web Design</strong><small data-i18n="mega.design.text">Wireframes, interfaces, landing pages, visual systems, and refined layouts.</small></a>
      <a class="mobile-service-link" href="service-design-development.html"><strong data-i18n="mega.designbuild.title">Design + Development</strong><small data-i18n="mega.designbuild.text">From design direction to responsive implementation and launch-ready pages.</small></a>
